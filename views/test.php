    ...
    <div class="container-fluid">
        <div class="row">
                                ...
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="produk_nama" required>
                                                <option value="">Pilih Produk</option>
                                                <?php foreach ($produks as $produkItem): ?>
                                                    <option value="<?= $produkItem['nama'] ?>"><?= $produkItem['nama'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kategori_tokoh_id" required>
                                                ...
                                                <?php foreach ($kategoris as $kategoriItem): ?>
                                                    <option value="<?= $kategoriItem['nama'] ?>"><?= $kategoriItem['nama'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="produk_id" required>
                                                <option value="">Pilih Produk</option>
                                                <?php foreach ($produks as $produkItem): ?>
                                                    <option value="<?= $produkItem['nama'] ?>" <?= $row['produk_id'] == $produkItem['nama'] ? 'selected' : '' ?>>
                                                        <?= $produkItem['nama'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="kategori_tokoh_id" required>
                                                <option value="">Pilih Kategori Tokoh</option>
                                                <?php foreach ($kategoris as $kategoriItem): ?>
                                                    <option value="<?= $kategoriItem['nama'] ?>" <?= $row['kategori_tokoh_id'] == $kategoriItem['nama'] ? 'selected' : '' ?>>
                                                        <?= $kategoriItem['nama'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            </select>
            ...
            if (isset($_POST['type']) && $_POST['type'] == 'tambah') {
                if (!empty($_POST['tanggal']) && !empty($_POST['nama_tokoh']) && !empty($_POST['komentar']) && !empty($_POST['rating']) && !empty($_POST['produk_id']) && !empty($_POST['kategori_nama'])) {
                    $data = [
                    ...
                    if (isset($_POST['type']) && $_POST['type'] == 'edit') {
                        if (!empty($_POST['tanggal']) && !empty($_POST['nama_tokoh']) && !empty($_POST['komentar']) && !empty($_POST['rating']) && !empty($_POST['produk_id']) && !empty($_POST['kategori_tokoh_id'])) {
                            $data = [
                                'tanggal' => $_POST['tanggal'],
                                'nama_tokoh' => $_POST['nama_tokoh'],
                                'komentar' => $_POST['komentar'],
